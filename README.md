...
**Solução:**  
Foi desenvolvido o “InsightFlow”, uma plataforma web voltada à análise do comércio exterior brasileiro entre 2014 e 2024. O sistema disponibiliza rankings, consultas e análises estatísticas por estados, países, setores, SH4s e códigos NCM, além de recursos como mapa de calor da balança comercial brasileira e gráficos com regressão linear, volatilidade e crescimento mensal. O backend foi desenvolvido em Python com Flask utilizando PostgreSQL e Redis, enquanto o frontend utilizou React, TypeScript, Vite e TailwindCSS. A aplicação possui uma arquitetura dockerizada e foi integrada a um modelo SARIMA para previsão de tendências.
