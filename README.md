...
## 👤 Introdução
<img align="left" src="./img/foto_juliaPereira.jpg" alt="foto" width="41%" >
...
| ![Python](https://img.icons8.com/?size=100&id=13441&format=png&color=000000) | ![JavaScript](https://img.icons8.com/?size=100&id=108784&format=png&color=000000) | ![TypeScript](https://img.icons8.com/?size=100&id=uJM6fQYqDaZK&format=png&color=000000) | ![Java](https://img.icons8.com/?size=100&id=13679&format=png&color=000000) | ![HTML5](https://img.icons8.com/?size=100&id=20909&format=png&color=000000) | ![CSS3](https://img.icons8.com/?size=100&id=21278&format=png&color=000000) | ![TailwindCSS](https://img.icons8.com/?size=100&id=CIAZz2CYc6Kc&format=png&color=000000) | ![React](https://img.icons8.com/?size=100&id=asWSSTBrDlTW&format=png&color=000000) | ![Vite](https://img.icons8.com/?size=100&id=dJjTWMogzFzg&format=png&color=000000) |
|-----------------|----------------|----------------|-----------------|-----------------|----------------|----------------|-----------------|----------------|
| ![Bootstrap](https://img.icons8.com/?size=100&id=EzPCiQUqWWEa&format=png&color=000000) | ![Expo](https://img.icons8.com/?size=100&id=7ImWFDcPfSlz&format=png&color=000000) | ![Flask](https://img.icons8.com/?size=100&id=AqYCfGyGXlO7&format=png&color=000000) | ![Django](https://img.icons8.com/?size=100&id=qV-JzWYl9dzP&format=png&color=000000) | ![Node.js](https://img.icons8.com/?size=100&id=hsPbhkOH4FMe&format=png&color=000000) | ![MySQL](https://img.icons8.com/?size=100&id=UFXRpPFebwa2&format=png&color=000000) | ![MongoDB](https://img.icons8.com/?size=100&id=8rKdRqZFLurS&format=png&color=000000) | ![MongoDB](https://img.icons8.com/?size=100&id=33039&format=png&color=000000) | ![WordPress](https://img.icons8.com/?size=100&id=v9uZbuVoWleB&format=png&color=000000) |
...
**Solução:**  
Foi desenvolvida a solução local “IDScan”, um aplicativo desktop em Java capaz de digitalizar documentos RG e armazenar os dados extraídos em um banco MySQL local, sem dependência de APIs externas. O sistema utiliza OCR com Tesseract e modelos de linguagem executados via Ollama para identificar automaticamente informações como CPF, data de nascimento, naturalidade e filiação a partir das imagens do documento. O usuário realiza o upload das imagens da frente e do verso do RG, podendo corrigir manualmente informações extraídas de forma incorreta ou incompleta. Após a validação, os dados podem ser salvos e consultados futuramente dentro da própria aplicação.
...
**Solução:**  
Foi desenvolvido o “InsightFlow”, uma plataforma web voltada à análise de dados de importação e exportação do Brasil entre 2014 e 2024. O sistema disponibiliza painéis interativos, rankings, análises estatísticas e previsões de tendências comerciais, permitindo consultas por estados, países, setores, SH4s e códigos NCM. A plataforma também conta com recursos como mapa de calor da balança comercial brasileira, filtros temporais e gráficos com análises de regressão linear, volatilidade e crescimento mensal. O backend foi desenvolvido em Python com Flask utilizando PostgreSQL e Redis, enquanto o frontend utilizou React, TypeScript, Vite e Tailwind CSS. A aplicação foi estruturada em uma arquitetura dockerizada e integrada a um modelo SARIMA para a previsão de tendências.
